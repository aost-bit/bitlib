(function (bitlib) {
    ...
    bitlib.string = (function () {
        ...
        self.replaceToEmcode = function (str) {
            ...
            for (var i = 0, len = MONOBYTE_KANA_CHARS.length; i < len; i++) {
                while (self.contains(str, MONOBYTE_KANA_CHARS[i])) {
                    str = str.replace(MONOBYTE_KANA_CHARS[i], DUOBYTE_KANA_CHARS[i]);
                }
            }
